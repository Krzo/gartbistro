...
<body>
                ...
                <div style="padding-left: 15px;">
                    <a href="https://www.lieferservice.at/snackman">
                        <button type="button" class="navbar-toggle pull-left">
                            <!--<span class="sr-only">Toggle navigation</span> Menu --><i class="fa fa-shopping-cart"></i> </button>
                    </a>
                </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-2 pull-left"> <a href="#" class="nav-tabs-dropdown btn btn-block btn-primary">Tabs</a>
            ...
            <div class="col-md-7">
                <div class="tab-content">
                                ...
                                <?php
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <div class="menu-item-price"> €
                                            <?php echo $food_price; ?> <a class="item_add" href="javascript: simpleCart.add({name:'<?php echo $food_name; ?>',price: <?php echo $food_price; ?>});">+ </a> </div>
                            ...
                            <div class="menu-section">
                                ...
                                <?php
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <div class="menu-item-price"> €
                                            <?php echo $food_price; ?> <a class="item_add" href="javascript: simpleCart.add({name:'<?php echo $food_name; ?>',price: <?php echo $food_price; ?>}); additemtocart(<?php echo $food_id?>)">+ </a> </div>
                                        <div class="menu-item-description">
                                            <?php echo $food_description; ?>
                                        </div>
                                    </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="vtab2">
                        <div class="menu-body">
                            <!-- Section starts: Burger -->
                            <div class="menu-section">
                                <h3 class="menu-section-title">Burger</h3>
                                <?php
                                    $sql  ="SELECT * FROM food";
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="vtab2">
                        <div class="menu-body">
                            <!-- Section starts: Empfehlung d. Hauses -->
                            <div class="menu-section">
                                <h3 class="menu-section-title">Unsere Empfehlung</h3>
                                <?php
                                    $sql  ="SELECT * FROM food";
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="vtab2">
                        <div class="menu-body">
                            <!-- Section starts: Salate -->
                            <div class="menu-section">
                                <h3 class="menu-section-title">Salate</h3>
                                <?php
                                    $sql  ="SELECT * FROM food";
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="vtab2">
                        <div class="menu-body">
                            <!-- Section starts: Getränke -->
                            <div class="menu-section">
                                <h3 class="menu-section-title">Getränke</h3>
                                <?php
                                    $sql  ="SELECT * FROM food";
            ...
            <div class="col-md-3 pre-scrollable">
                <div data-spy="affix" data-offset-top="205">
                    ...
                    <span class="simpleCart_quantity"></span> Speisen - <span class="simpleCart_total"></span>
                    <br/>
                    <a href="javascript: additemtocart(simpleCart_items);" class="simpleCart_checkout">
                        <button type="button" class="btn btn-success">Bezahlen</button>
                    </a>
                    <br/>
                    <a href="javascript:simpleCart.empty();" class="">
                        <button type="button" class="btn btn-info">Test Warenkorb leeren</button>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="footer text-center spacer">
        <p class="wowload flipInX"><a href="https://www.facebook.com/GART-Bistro-in-Mäder-1826884027630066/"><i class="fa fa-facebook fa-2x"></i></a> <a href="#"><i class="fa fa-instagram fa-2x"></i></a> <a href="#"><i class="fa fa-twitter fa-2x"></i></a></p> Copyright 2017 Gart Bistro. All rights reserved. </div>
    <!-- # Footer Ends --><a href="#home" class="gototop"><i class="fa fa-angle-up  fa-3x"></i></a>
    <!-- jquery -->
