...
google.maps.event.addDomListener(window, 'load', init);
    ...
    function init() {
        var mapOptions = {
            center: new google.maps.LatLng(47.3531513,9.6292871),
            zoom: 12,
            zoomControl: true,
            zoomControlOptions: {
        ...
        var locations = [
['Gart Bistro', 'Mähderle 1', '6841 Mäder', 'email@email.com', 'gartbistro.at', 47.3531513,9.6292871, 'https://mapbuildr.com/assets/img/markers/solid-pin-blue.png']
        ];
